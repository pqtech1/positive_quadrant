...
OurPartner Details<small> into the table.</small>
...
<h3>OUR PARTNER<button type="button" class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#modal-top"> <i class="fa fa-plus fa-1x"></i> Add </button></h3>
                            ...
                            <div class="responsive" style="overflow:scroll;">
                              ...
                              foreach ($test as  $value) {
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                          <img src=" <?php echo base_url( 'uploads/partners/'.$value['partner_image']);?>" height="50" width="50">&nbsp;&nbsp;&nbsp;&nbsp;
                                          </td>
                                          <td>
                                          ...
                                          <div class="btn-group">
                                                    ...
                                                    <a  class="btn btn-xs btn-default update-modal" id ="<?php echo $value['partner_id']; ?>" type=" button" data-toggle="tooltip" title="" data-original-title="Edit Partner"><i class="fa fa-pencil"></i></a>

                                                    <a href="javascript:void(0)" onclick="delete_data('<?= $value["partner_id"] ?>')" class="btn btn-xs btn-default" type="button" data-toggle="tooltip"  data-original-title="Remove Partner"><i class="fa fa-times"></i></a>
                ...
                <div class="modal-content">
                    ...
                    <div class="block block-themed block-transparent remove-margin-b">
                        ...
                        <div class="block-header bg-primary-dark">
                            ...
                            <h3 class="block-title">ADD OUR PARTNER</h3>
                        ...
                        <div class="block-content">
                           ...
                           <form  id ="add_director" class="form-horizontal" method="post" enctype="multipart/form-data">
                                 ...
                                 <div class="form-group">
                                     ...
                                     <label class="control-label col-md-2">Name Of Partner </label>
                ...
                <div class="modal-content">
                    ...
                    <div class="block block-themed block-transparent remove-margin-b">
                        ...
                        <div class="block-header bg-primary-dark">
                            ...
                            <h3 class="block-title">EDIT OUR PARTNER</h3>
                             ...
                             <div class="form-group">
                                     ...
                                     <label class="control-label col-md-2">Name Of Partner </label>
                                         ...
                                         <div class="col-md-10">
                                            ...
                                            <input type="text" name="partner_name" id="edt_partner_name" class="form-control">
...

  {
...

    {
      ...
      $.ajax({
           ...
           url: "<?php echo base_url('Ourpartner/add_home'); ?>",
...
<script type="text/javascript">
...

  {
    ...
    $.ajax({
       ...
       url: "<?php echo base_url('Ourpartner/edit_home/'); ?>"+id,
       ...
       success:function(data){
        ...
        $('#partner_id').val(data[0].partner_id);
         $('#data_image').val(data[0].partner_image);
         $('#edr_status').val(data[0].status);
          $('#edt_partner_name').val(data[0].partner_name);
...

{
    ...
    if( $('#edit_image').val() != "" && !allowedExtensions.exec(filePath))
    {
       ...
       $.ajax({
                 ...
                 url: "<?php echo base_url('Ourpartner/updateDirect/'); ?>"+id,
...

    {
...

      {
          ...
          $.ajax({
            ...
            url:'<?= base_url() ?>Ourpartner/delete_workshop/'+id,
