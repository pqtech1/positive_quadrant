...
<head>
    ...
    <title>IndustrySubDetails</title>
...
<main id="main-container">
    ...
    <script type="text/javascript">
        ...
        $('#createForm').on('submit', function (event) {
            ...
            $.ajax({
                url: "<?php echo base_url('subDetails/IndustriesSubDetails/create'); ?>",
                method: "POST",
        ...
        function loadDatatableAjax() {
            ...
            $('#example1').DataTable({
                "bDestroy": true,
                "ajax": {
                    "url": "<?php echo base_url('subDetails/IndustriesSubDetails/fetchDatafromDatabase'); ?>",
            ...
            $('#example1').on('click', '.view-details', function () {
                ...
                $.ajax({
                    url: "<?php echo base_url('subDetails/IndustriesSubDetails/getEditData'); ?>",
                    method: "POST",
                    data: { id: id },
                    dataType: "json",
                    success: function (response) {
        ...
        $("#editForm").submit(function (event) {
            ...
            $.ajax({
                url: "<?php echo base_url('subDetails/IndustriesSubDetails/update'); ?>",
                data: formData,
                type: "post",
                processData: false,
                contentType: false,
        ...
        function deleteFun(id) {
            if (confirm("Are you sure you want to delete this record?")) {
                $.ajax({
                    url: "<?php echo base_url('subDetails/IndustriesSubDetails/deleteSingleData'); ?>",
                    method: "post",
                    data: { id: id },
                    dataType: "json",
                    success: function (response) {
