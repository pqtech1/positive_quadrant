...
|
*/
/*base_url and image_path set dynamic*/
// $root = "http://".$_SERVER['HTTP_HOST'];
// $root .= str_replace(basename($_SERVER['SCRIPT_NAME']),"",$_SERVER['SCRIPT_NAME']);
// $config['base_url']    = "$root";
// //$config['base_url'] = 'http://positivequadrant.in/';
// $config['image_path'] = $config['base_url'].'adminpositivequadrant';
...
if ($hostname == 'localhost' || $hostname == '127.0.0.1') {
    ...
    // Default case (can be customized if needed)
    $base_url = 'http://' . $hostname . '/';
}

// Now assign to the config array
$config['base_url'] = $base_url;
$config['image_path'] = $base_url . '/admin';
