...
public $v_fields=array('name', 'mobile','current_add','permanent_add','avatar','status');

 



	function getList($table, $pagination=array(),$from="",$to="",$s="",$status="") {
        ...
        // SEARCH END
...

            {
                ...
                $this->db->where("date(created) BETWEEN '$from' AND '$to'");
    ...
    function getCount($table, $key='', $value='',$from="",$to="",$s='',$status='') {
