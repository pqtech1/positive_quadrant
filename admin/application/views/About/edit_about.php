        ...
        <div class="row items-push">
            ...
            <div class="col-sm-7">
                ...
                <h1 class="page-heading">
                    ...
                    Edit About Details <small> into the table.</small>
        ...
        <div class="block block-bordered">
            ...
            <div class="block-content">
                ...
                <form class="form-horizontal push-10-t push-10" action="" method="post" id="editform" enctype="multipart/form-data">
                   ...
                   <?php foreach($about_data as $value) {?>
                        <input type="hidden" name="about_id" id="about_id" value="<?= $value['about_id']?>">
                
                          <input type="hidden" class="form-control" name="old_img"  value="<?= $value['about_image']?>" />
                    ...
                    <div class="row">
                      <div class="form-group">
                       <div class="col-xs-6">
                        ...
                        <?php if(!empty($value['about_image'])) {?>
                        <img src="<?= base_url()?>/uploads/about/<?= $value['about_image']?>" width="100px" 
                        height="150px"></img>
                        <?php } ?>
                    </div>
                </div>           
            ...
            <div class="row">
              <div class="form-group">
                    <div class="col-xs-12">
                        <textarea class="form-control ckeditor" id="about_desc" name="about_desc" rows="7" placeholder="Enter Description.."><?= $value['about_desc']?></textarea>
