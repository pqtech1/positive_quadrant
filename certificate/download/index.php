...
$sql = $conn->prepare("SELECT * FROM certificates where id={$decoded_id}");
//echo $query; die;
$sql->execute();
$data = $sql->fetch(PDO::FETCH_ASSOC);

$update = $conn->prepare("UPDATE certificates SET link_open_dt = NOW() WHERE id ={$decoded_id};");
$update->execute();
} else {
        ...
        <div id="asidebar" style="display:none;"> 
          ...
          <div id="inputs">
            ...
            <div>
              ...
              <input
                type="text"
                value="On <?php echo $data['course_name']; ?>"
                data-fontsize="3"
                data-font="Verdana"
                data-textalign="center"
                data-x="50"
              ...
              <input
                type="text"
                value="<?php echo $data['start_date']." to ".$data['end_date']?>"
                data-fontsize="2"
                data-font="Verdana"
                data-textalign="center"
                data-x="30"
