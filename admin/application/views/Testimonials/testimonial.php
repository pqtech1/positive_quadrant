...
<main id="main-container">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Client Description"
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control-file" name="client_image">
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <form id="editForm" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="client_old_image" id="editOldImage">
                        <div class="form-group">
                            <label>Client Name</label>
                            <input type="text" class="form-control" placeholder="Client Name" name="client_name"
                                id="edit_client_name">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="  Description"
                                name="client_description" id="edit_client_description">
                        </div>
                        <div class="form-group">
                            <label>Student Status</label>
    ...
    <script type="text/javascript">
        ...
        $("#createForm").submit(function (event) {
            ...
            $.ajax({
                url: "<?php echo base_url('Testimonial/create'); ?>",
                data: formData,
                type: "post",
                processData: false,
                contentType: false,
        ...
        function loadDatatableAjax() {
            $('#example1').DataTable({
                "bDestroy": true,
                "ajax": "<?php echo base_url('Testimonial/fetchDatafromDatabase'); ?>",
        ...
        function editFun(id) {
            $.ajax({
                url: "<?php echo base_url('Testimonial/getEditData'); ?>",
                method: "post",
                data: { id: id },
                dataType: "json",
                success: function (response) {
                    ...
                    $('#edit_client_description').val(response.client_description);
                    $('#edit_status').val(response.status);
                    $('#editOldImage').val(response.client_image); // Set the old image name in the hidden field
                    $('#imageContainer').html('<img src="<?php echo base_url('./uploads/testimonials/'); ?>' + response.client_image + '" alt="Image" style="width: 100px;">');
                    $('#editModal').modal({
                        backdrop: "static",
                        keyboard: false
                    });
        ...
        function deleteFun(id) {
            if (confirm("Are you sure you want to delete this record?")) {
                $.ajax({
                    url: "<?php echo base_url('Testimonial/deleteSingleData'); ?>",
                    method: "post",
                    data: { id: id },
                    dataType: "json",
                    success: function (response) {
