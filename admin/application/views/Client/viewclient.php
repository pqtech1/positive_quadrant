...
Client Details<small> into the table.</small>
...
<h3>CLIENT <button type="button" class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#modal-top"> <i class="fa fa-plus fa-1x"></i> Add </button></h3>
                              ...
                              foreach ($test as  $value) {
                                        ...
                                        <tr>
                                          ...
                                          <td><?php  
                                           ...
                                           $asd = explode(',',$value['client_image'] );

                                          foreach( $asd as $image) { ?>

                                          <img src=" <?php echo base_url( 'uploads/client/'.$image);?>" height="50" width="50">&nbsp;&nbsp;&nbsp;&nbsp;
                                          ...
                                          <td>
                                          <div class="btn-group">
                                                    <a  class="btn btn-xs btn-default update-modal" id ="<?php echo $value['id']; ?>" type=" button" data-toggle="tooltip" title="" data-original-title="Edit Client"><i class="fa fa-pencil"></i></a>
                                                    <a href="javascript:void(0)" onclick="delete_data('<?= $value["id"] ?>')" class="btn btn-xs btn-default" type="button" data-toggle="tooltip"  data-original-title="Remove Client"><i class="fa fa-times"></i></a>
                                          </div> 
                                          </td>
                                          </tr>
                                          <?php }  ?>
...
function delete_data(id)
    {
      ...
      if(confirm('Are you sure you want to delete this item?'))
      {
          $.ajax({
            ...
            url:'<?= base_url() ?>client/delete_client/'+id,
