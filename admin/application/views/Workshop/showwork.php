...
Workshop Details<small> into the table.</small>
...
<h3>WORKSHOP <button type="button" class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#modal-top"> <i class="fa fa-plus fa-1x"></i> Add </button></h3>
                            ...
                            <div class="responsive" style="overflow:scroll;">
                              ...
                              foreach ($test as  $value) {
                                        ...
                                        <tr>
                                          ...
                                          <img src=" <?php echo base_url( 'uploads/workshop/'.$image);?>" height="50" width="50">&nbsp;&nbsp;&nbsp;&nbsp;
                                          ...
                                          <div class="btn-group">
                                                    ...
                                                    <a  class="btn btn-xs btn-default update-modal" id ="<?php echo $value['work_id']; ?>" type=" button" data-toggle="tooltip" title="" data-original-title="Edit Workshop"><i class="fa fa-pencil"></i></a>

                                                    <a href="javascript:void(0)" onclick="delete_data('<?= $value["work_id"] ?>')" class="btn btn-xs btn-default" type="button" data-toggle="tooltip"  data-original-title="Remove Workshop"><i class="fa fa-times"></i></a>
                ...
                <div class="modal-content">
                    ...
                    <div class="block block-themed block-transparent remove-margin-b">
                        ...
                        <div class="block-header bg-primary-dark">
                            ...
                            <h3 class="block-title">ADD WORKSHOP</h3>
                                 ...
                                 <div class="form-group">
                                     ...
                                     <label class="control-label col-md-2">Description </label>
                                         ...
                                         <div class="col-md-10">
                                            ...
                                            <textarea class="form-control" id="work_desc" name="work_desc" rows="7" placeholder="Enter Description.." ></textarea>
                ...
                <div class="modal-content">
                    ...
                    <div class="block block-themed block-transparent remove-margin-b">
                        ...
                        <div class="block-header bg-primary-dark">
                            ...
                            <h3 class="block-title">EDIT WORKSHOP</h3>
                             ...
                             <div class="form-group">
                                     ...
                                     <label class="control-label col-md-2">Description </label>
                                         ...
                                         <div class="col-md-10">
                                            ...
                                            <textarea class="form-control" id="work_desc_edt" name="work_desc_edt" rows="7" placeholder="Enter Description.." ></textarea>
...

  {
...

    {
      ...
      $.ajax({
           ...
           url: "<?php echo base_url('Workshop/add_home'); ?>",
...
<script type="text/javascript">
...

  {
    ...
    $.ajax({
       ...
       url: "<?php echo base_url('Workshop/edit_home/'); ?>"+id,
       ...
       success:function(data){
        ...
        $('#direct_id').val(data[0].work_id);



         $('#data_image').val(data[0].work_image);
         ...
         $('#edr_status').val(data[0].status);
          ...
          $('#work_desc_edt').val(data[0].work_desc);
...

{
...

    {
       ...
       $.ajax({
                 ...
                 url: "<?php echo base_url('Workshop/updateDirect/'); ?>"+id,
...

    {
...

      {
          ...
          $.ajax({
            ...
            url:'<?= base_url() ?>Workshop/delete_workshop/'+id,
