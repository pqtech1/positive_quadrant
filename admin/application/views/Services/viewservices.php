   ...
   <div class="content content-narrow">
      ...
      <div class="block block-bordered">
         <div class="block-header bg-gray-lighter">
            ...
            <h3>SERVICES <button type="button" class="btn btn-success btn-sm pull-right" onclick="show_data()"> <i class="fa fa-plus fa-1x"></i> Add </button></h3>
         </div>
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="btn-group">
                                 ...
                                 <a  class="btn btn-xs btn-default edit_modal" href="<?php echo base_url().'Services/edit_services/'.$value['s_id']; ?>" type=" button" data-toggle="tooltip" title="" data-original-title="Edit "><i class="fa fa-pencil"></i></a>
                                 <!-- <a href="javascript:void(0)" onclick="delete_data('<?= $value["s_id"]; ?>')" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="" data-original-title="Remove"><i class="fa fa-times"></i></a> -->
                              </div>
                           </td>
                           <td>
                              <a  class="btn btn-xs btn-default" type="button" data-toggle="tooltip" data-original-title="Add Service Details" href="<?php echo base_url().'Services/add_serviceDetail/'.$value['s_id'] ?>"><i class="fa fa-plus fa-1x"></i></a>/
                               <a class="btn btn-xs btn-default" type="button" data-toggle="tooltip"  data-original-title="View Service Details" href="<?php echo base_url().'Services/view_service_detail/'.$value['s_id'] ?>"><i class="fa fa-eye"></i></a>
                           </td>
                        </tr>
                        <?php }  ?>
                     </tbody>
...
<script type="text/javascript">
   ...
   // }
     ...
     function show_data()
     {
        window.location.href="<?= base_url()?>Services/show_add";
     }
         ...
         // alert(id);
   ...
   
           {
               ...
               $.ajax({
                 ...
                 url:'<?= base_url() ?>Services/delete_services/'+id,
