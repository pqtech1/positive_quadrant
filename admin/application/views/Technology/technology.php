...
<main id="main-container">
    ...
    <script type="text/javascript">
        ...
        $("#createForm").submit(function (event) {
            ...
            $.ajax({
                url: "<?php echo base_url('Technology/create'); ?>",
                data: formData,
                type: "post",
                processData: false,
                contentType: false,
        ...
        function loadDatatableAjax() {
            $('#example1').DataTable({
                "bDestroy": true,
                "ajax": "<?php echo base_url('Technology/fetchDatafromDatabase'); ?>",
        ...
        function editFun(id) {
            $.ajax({
                url: "<?php echo base_url('Technology/getEditData'); ?>",
                method: "post",
                data: { id: id },
                dataType: "json",
                success: function (response) {
                    ...
                    $('#imageContainer').html('<img src="<?php echo base_url('./uploads/technology/'); ?>' + response.image + '" alt="Image" style="width: 100px;">');
                    $('#editModal').modal({
                        backdrop: "static",
                        keyboard: false
                    });
        ...
        $("#editForm").submit(function (event) {
            ...
            $.ajax({
                url: "<?php echo base_url('Technology/update'); ?>",
                data: formData,
                type: "post",
                processData: false,
                contentType: false,
        ...
        function deleteFun(id) {
            if (confirm("Are you sure you want to delete this record?")) {
                $.ajax({
                    url: "<?php echo base_url('Technology/deleteSingleData'); ?>",
                    method: "post",
                    data: { id: id },
                    dataType: "json",
                    success: function (response) {
