...
<?php echo ucwords($course['cname']); ?>  Syllabus Details<small> into the table.</small>
...
<h3> <?php echo strtoupper($course['cname']); ?> SYLLABUS <a type="button" class="btn btn-success btn-sm pull-right" href="<?php echo base_url().'Courses'?>"> GO BACK TO COURSES </a></h3>
...
<?php  $url_id = $_SERVER['REQUEST_URI']; 
    $url_id = substr($url_id, strrpos($url_id, '/') + 1);
                            ...
                            <div class="responsive" style="overflow:scroll;">
                              ...
                              foreach ($syllabus as  $value) {
                                        ...
                                        <tr>
                                          ...
                                          <td><?php echo $value['scontent']; ?></td>
                                          <td><a  href="<?php echo base_url().'uploads/syllabus/'.$value['spdf'].'';?>"class="btn btn-xs btn-default" data-toggle="tooltip" data-original-title="VIEW SYLLABUS PDF"><i class="fa fa-eye"></i></a>
                                          </td>

                                          <td><?php echo ($value['status'] == 1) ? '<span style="color:green">ACTIVE</span>' : '<span style="color:red">INACTIVE</span>'; ?>
                                          </td>
                                          <td>
                                            <div class="btn-group">
                                                    <a   href="<?php echo base_url().'courses/edit_syllabus/'.$url_id.'/'.$value['s_id'].''?>" class="btn btn-xs btn-default update-modal" id ="" type=" button" data-toggle="tooltip" title="" data-original-title="Edit Syllabus"><i class="fa fa-pencil"></i></a>
                                                    <a href="javascript:void(0)" onclick="delete_data('<?= $value["s_id"] ?>')" class="btn btn-xs btn-default" type="button" data-toggle="tooltip"  data-original-title="Remove Syllabus"><i class="fa fa-times"></i></a>
                                            </div>
                                          </td>
...
function delete_data(id)
    {
      ...
      if(confirm('Are you sure you want to delete this item?'))
      {
          $.ajax({
            ...
            url:'<?= base_url() ?>courses/delete_syllabus/'+id,
