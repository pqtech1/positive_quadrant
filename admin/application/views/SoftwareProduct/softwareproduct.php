<main id="main-container">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Add Software Product</h5>
    ...
    <script type="text/javascript">
        ...
        $("#createForm").submit(function (event) {
            ...
            $.ajax({
                url: "<?php echo base_url('SoftwareProduct/create'); ?>",
                data: formData,
                type: "post",
                processData: false,
                contentType: false,
        ...
        function loadDatatableAjax() {
            $('#example1').DataTable({
                "bDestroy": true,
                "ajax": "<?php echo base_url('SoftwareProduct/fetchDatafromDatabase'); ?>",
        ...
        function editFun(id) {
            ...
            $.ajax({
                url: "<?php echo base_url('SoftwareProduct/getEditData'); ?>",
                method: "post",
                data: { id: id },
                dataType: "json",
                success: function (response) {
                    ...
                    $('#imageContainer').html('<img src="<?php echo base_url('./uploads/softwareproducts/'); ?>' + response.image + '" alt="Image" style="width: 100px;">');
                    $('#editModal').modal({
                        backdrop: "static",
                        keyboard: false
                    });
        ...
        $("#editForm").submit(function (event) {
            ...
            $.ajax({
                url: "<?php echo base_url('SoftwareProduct/update'); ?>",
                data: formData,
                type: "post",
                processData: false,
                contentType: false,
        ...
        function deleteFun(id) {
            if (confirm("Are you sure you want to delete this record?")) {
                $.ajax({
                    url: "<?php echo base_url('SoftwareProduct/deleteSingleData'); ?>",
                    method: "post",
                    data: { id: id },
                    dataType: "json",
                    success: function (response) {
