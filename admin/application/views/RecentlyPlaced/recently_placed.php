...
<main id="main-container">
    ...
    <style type="text/css">
        #example1_wrapper {
            ...
            padding-right: 10vw #example1_wrapper img {
                width: auto;
                height: 8vh
            }
    </style>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Add Recently Placed</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Student Description"
                                    name="student_description">
                            </div>
                            <div class="form-group">
                                <label>Student LinkedIn Link</label>
                                <input type="text" class="form-control" placeholder="Student LinkedIn Link"
                                    name="student_linkedIn_link">
                            </div>
                            <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <form id="editForm" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="student_old_image" id="editOldImage">
                        <div class="form-group">
                            <label>Student Name</label>
                            <input type="text" class="form-control" placeholder="Student Name" name="student_name"
                        ...
                        <div class="form-group">
                            <label>Student Description</label>
                            <input type="text" class="form-control" placeholder="Student Description"
                                name="student_description" id="edit_student_description">
                        </div>
                        <div class="form-group">
                            <label>Student LinkedIn Link</label>
                            <input type="text" class="form-control" placeholder="Student LinkedIn Link"
                                name="student_linkedin_link" id="edit_student_linkedIn_link">
                        </div>
                        <div class="form-group">
                            <label>Student Status</label>
    ...
    <script type="text/javascript">
        ...
        $("#createForm").submit(function (event) {
            ...
            $.ajax({
                url: "<?php echo base_url('RecentlyPlaced/create'); ?>",
                data: formData,
                type: "post",
                processData: false,
                contentType: false,
        ...
        function loadDatatableAjax() {
            $('#example1').DataTable({
                "bDestroy": true,
                "ajax": "<?php echo base_url('RecentlyPlaced/fetchDatafromDatabase'); ?>",
        ...
        function editFun(id) {
            $.ajax({
                url: "<?php echo base_url('RecentlyPlaced/getEditData'); ?>",
                method: "post",
                data: { id: id },
                dataType: "json",
                success: function (response) {
                    ...
                    $('#edit_student_description').val(response.student_description);
                    $('#edit_student_linkedIn_link').val(response.student_linkedin_link);
                    $('#edit_status').val(response.status);
                    $('#editOldImage').val(response.student_image); // Set the old image name in the hidden field
                    $('#imageContainer').html('<img src="<?php echo base_url('./uploads/RecentlyPlaced/'); ?>' + response.student_image + '" alt="Image" style="width: 100px;">');
                    $('#editModal').modal({
                        backdrop: "static",
                        keyboard: false
                    });
        ...
        $("#editForm").submit(function (event) {
            ...
            $.ajax({
                url: "<?php echo base_url('RecentlyPlaced/update'); ?>",
                data: formData,
                type: "post",
                processData: false,
                contentType: false,
        ...
        function deleteFun(id) {
            if (confirm("Are you sure you want to delete this record?")) {
                $.ajax({
                    url: "<?php echo base_url('RecentlyPlaced/deleteSingleData'); ?>",
                    method: "post",
                    data: { id: id },
                    dataType: "json",
                    success: function (response) {
