...
<!-- 
 ...
 <h3><a type="button" class="btn btn-success btn-sm pull-right" href="<?php echo base_url('project/show_add')?>" > <i class="fa fa-plus fa-1x"></i> Add </a> </h3> 
                                          ...
                                          foreach ($test as  $value) {
                                           ...
                                           ?>
                                            ...
                                            <tr>
                                                ...
                                                <td> 
                                                <img src="<?php echo base_url( 'uploads/project/'. $value['project_image']); ?>" height="50" width="50"></td>
                                                ...
                                                <td> <div class="btn-group">
                                                    <a href="<?php echo base_url().'/project/edit_home/'.$value['project_id'] ?>" class="btn btn-xs btn-default" type="button"  data-toggle="tooltip" data-original-title="Edit Project"><i class="fa fa-pencil"></i></a>   

                                                    <a href="javascript:void(0)" onclick="return isconfirm('<?php echo base_url('project/delete_home/'.$value['project_id']); ?>')" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="" data-original-title="Remove Project"><i class="fa fa-times"></i></a>
